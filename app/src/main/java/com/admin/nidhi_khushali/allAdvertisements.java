...
public class allAdvertisements extends AppCompatActivity {
    ...
    public void initViews(){
        ...
        listViewAll_adv=(ListView) findViewById(R.id.listAllAdv);
    ...
    public void fetchDetails(){
        ...
        listViewAll_adv.setAdapter(advAdapter);
    ...
    class getAdds extends AsyncTask {
        ...
        protected void onPreExecute() {
            ...
            pd=new ProgressDialog(allAdvertisements.this, ProgressDialog.THEME_DEVICE_DEFAULT_LIGHT);
        ...
        public String getJSON(){
            ...
            try {
                String url=Util.url_GetAllAdvertisements;
                URL x=new URL(url);
                ...
                Toast.makeText(allAdvertisements.this, "getJSON catch executed", Toast.LENGTH_SHORT).show();
                e.printStackTrace();
            }
            return sb.toString();
        }
        ...
        protected void onPostExecute(Object o) {
            ...
            try {
                ...
                if (jsonArray.length()>0){
                    ...
                    //Toast.makeText(allAdvertisements.this, "Oops! Error occured...", Toast.LENGTH_SHORT).show();
                }
            }
            catch (Exception e) {
                Toast.makeText(allAdvertisements.this, "Oops!catch executed...", Toast.LENGTH_SHORT).show();
    ...
    class deleteAdd extends AsyncTask {
        ...
        public String getJSON() {
            ...
            try {
                ...
                data = URLEncoder.encode("id", "UTF-8") + "=" + URLEncoder.encode(delAddId, "UTF-8");
        ...
        protected void onPostExecute(Object o) {
            ...
            try {
                //JSONArray jsonArray = new JSONArray(response);
                if (response.equals("[]")) ;
                Toast.makeText(allAdvertisements.this, "deleted successfully", Toast.LENGTH_SHORT).show();
    ...
    public void delete(){
        ...
        builder.setMessage("Are you sure you want to delete Advertisement with id= "+delAddId+" ?");
            ...
            btn_delete.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                 ...
                 /*   addId=arrListAdvId.get(index).toString().trim();
                    ...
                    context.startActivity(intent);*/
                    delAddId=arrListAdvId.get(index).toString().trim();
                    delete();
