...
public class candidateDetailsAdapter extends ArrayAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        view= LayoutInflater.from(context).inflate(R.layout.list_candidate_details,parent,false);
